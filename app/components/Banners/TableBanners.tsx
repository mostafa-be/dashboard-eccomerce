...
/**
 * TableBanners Component
 * Renders a table for displaying banners with sorting, filtering, and pagination functionality.
 *
 * @template TData - The type of data being displayed in the table.
 * @template TValue - The type of the column value.
 *
 * @param {TableBannersProps<TData, TValue>} props - The component props.
 ...
 */
interface TableBannersProps<TData, TValue> {
  columns: ColumnDef<TData, TValue>[];
  data: TData[];
}

export function TableBanners<TData, TValue>({
  columns,
  data,
}: TableBannersProps<TData, TValue>) {
