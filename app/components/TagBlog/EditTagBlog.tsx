...
import { useEditTagBlogMutation } from "@/redux/features/blogTags/blogTagsApi";
type EditTagBlogProps = {
  tag: {
    _id: string;
    name: string;
  };
...
const EditTagBlog = ({
  ...
  const { _id, name } = tag;
  const [editTagBlog, { isLoading, isSuccess, error }] =
  ...
  const handleSubmit = async (
    ...
    if (!isLoading) {
      ...
      await editTagBlog({ id: _id, data }).unwrap();
      resetForm();
    }
  };
