...
import { useDeleteBlogCategoryMutation, useGetAllCategoriesBlogQuery } from "@/redux/features/blogCategories/blogCategoriesApi";
...
export function AlertDeleteCategory({ _id }: AlertDeleteCategoryProps) {
  const [deleteBlogCategory, { isLoading, isSuccess, isError, error }] =
    useDeleteBlogCategoryMutation();
  const { refetch } = useGetAllCategoriesBlogQuery(
    {},
